...
class KEENSettings(Settings):
    ...
    SOCIAL_AUTH_TELEGRAM_BOT_TOKEN = SOCIAL_AUTH_TELEGRAM_BOT_TOKEN
    SOCIAL_AUTH_PROTECTED_USER_FIELDS = SOCIAL_AUTH_PROTECTED_USER_FIELDS
    SOCIAL_AUTH_VERIFY_SSL = SOCIAL_AUTH_VERIFY_SSL
